	...
	function InsideMain.Category(Text,imageId,ScaleType,imgTransparency)
		...
		function InsideCategory.Folder(Text)
			...
			function InsideFolder.Toggle(Text,callback,statement)
				...
				function abc_new.Set(statement)
			...
			function InsideFolder.Dropdown(placeholder)
				...
				Dropdown:GetPropertyChangedSignal("Text"):Connect(function(Property)
					for i,v in pairs(DropDownListFrame:GetChildren()) do
						if v:IsA("TextButton") then
				...
				function InsideDropdown.Toggle(Text,callback,statement)
					local Toggle = Instance.new("TextButton")
					local ToggleCorner = Instance.new("UICorner")
					local OuterBorder = Instance.new("Frame")
					local Corner = Instance.new("UICorner")
					...
					Toggle.Name = Text
					Toggle.Parent = DropDownListFrame
					Toggle.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
					Toggle.BorderSizePixel = 0
					Toggle.Size = UDim2.new(1, 0, 0, 35)--UDim2.new(0, 300, 0, 35)
					Toggle.AutoButtonColor = false
					Toggle.Font = Enum.Font.SourceSansBold
					Toggle.Text = "    " .. Text
					Toggle.TextColor3 = Color3.fromRGB(200, 200, 200)
